...
+ This means that grains smaller than 0.0015 micron = 1.5 nm would be destroyed [2019-02-02 Sat]qby sputtering
...
** TODO Dust decoupling in H II regions
+ Gail:1979a
...
+ Draine:2011a
  ...
  + Sputtering (sec 4.4) is interesting - shows that drift velocities > 75 km/s can lead to dust destruction by He ions
    ...
    + Whereas in our models, column will be of order n R_\dag or n v_\infty t
      ...
      - *Conclusion* Sputtering not important
