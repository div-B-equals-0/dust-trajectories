...
V = 40 and n = 1  (but this one has minimum radius < R_0, so it would be a bow shock, not a dust wave)
...
#+BEGIN_SRC sh :results file
python twod_traject.py 0.001 MS10 40 1.0 gra 0.02
#+END_SRC

#+RESULTS:
[[file:figs/twod-MS10-v040-n+10-gra002-Y0001.pdf]]
