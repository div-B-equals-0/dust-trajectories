...
+ There are at least 4 parameters:
  + L4, v, n, a
  + [ ] In principle \phi should be determined self-consistently
...
+ Density effects
  ...
  + [ ] /Speculation:/ at high enough density, we get into BW regime, where R_0 is also independent of density - in which case DW will merge in to BW (like when \alpha_drag > 100 in previous model)
** Grain potential versus U_P (aka \Upsilon_P)
